...
(async () => {
  ...
  if (!result.desktopBridge || result.navItems !== 7 || result.railWidth !== '72px') throw new Error(JSON.stringify(result));
  ...
  if (expandedWidth !== '220px') throw new Error(`Rail did not expand: ${expandedWidth}`);
