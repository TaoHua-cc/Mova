...
[Messages]
AboutSetupNote=请访问 %1 获取最新版本和支持信息。
BeveledLabel=创建于 %1
SetupAppTitle=安装
...
InvalidPath=您必须输入一个带驱动器盘符的完整路径，例如：%n%nC:\App%n%n或 UNC 路径：%n%n\\server\share
...
SelectComponentsLabel2=选中您想要安装的组件；取消您不想安装的组件。然后点击“下一步”继续。
